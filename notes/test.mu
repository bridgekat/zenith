...
// (We don't have "disjointness constraints", as we use de Brujin indices and every substitution will be proper!)
anypred q/2 any x y {
...
// "Extension by definitions" is another kind of conservative extension (TODO: make clear aboud dd and id), which allows us to "define" a function or predicate...
any x y {
