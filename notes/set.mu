    ...
    assume (forall x, (exists a ∈ x) -> (exists y ∈ x, not exists z, z ∈ x and z ∈ y))
      ...
      assume (forallpred φ/2, forall x, exists y, forall a, a ∈ y <-> a ∈ x and φ x a)
        ...
        anypred φ/2 any x {
          ...
          => (exists_unique y, forall a, a ∈ y <-> (a ∈ x and φ x a));
        ...
        => (forall x, exists_unique y, forall a, a ∈ y <-> (a ∈ x and false));
        => (exists_unique x, forall y, y ∉ x);
        ...
        assume (forall x y, exists z, x ∈ z and y ∈ z)
          ...
          any x y {
            ...
            => (exists_unique z, forall a, a ∈ z <-> a = x or a = y) by set_ext;
          ...
          assume (forall f, exists z, forall x ∈ f, forall a ∈ x, a ∈ z)
            name unionset_primitive
                 ...
                 "the union over the elements of a set exists (primitive form)" {
            ...
            any F {
              ...
              => (exists_unique z, forall a, a ∈ z <-> (exists x ∈ F, a ∈ x)) by set_ext;
            ...
            // Since definite description is already built into the logic, the replacement schema can be written equivalently as:
            assume (forallfunc φ/2, forall x, exists y, forall a ∈ x, exists b ∈ y, b = φ x a)
              name imageset_primitive
                   "axiom schema of image sets (primitive form)"
                   "axiom schema of replacement (primitive form)"
                   "for any definable function over a given set, some codomain set exists (primitive form)" {
              
              // A more useful form ("exactly" the image set...)
              anyfunc φ/2 any x {
                any y' assume (forall a ∈ x, exists b ∈ y', b = φ x a) {
                  // (TODO: complete)
                }
                => (exists        y, forall b, b ∈ y <-> (exists a ∈ x, b = φ x a)) by exists.e;
                => (exists_unique y, forall b, b ∈ y <-> (exists a ∈ x, b = φ x a)) by set_ext;
                def  imageset :: (forall b, b ∈ imageset <-> (exists a ∈ x, b = φ x a))
                name imageset_def
                     "definition of the image of a function φ"
                     "the image set of a function φ contains exactly those elements obtained by applying this function on a given set x";
              }
              ...
              assume (exists x, emptyset ∈ x and forall a ∈ x, (pairset a (singletonset a)) ∈ x)
                ...
                assume (forall x, exists y, forall z ⊆ x, z ∈ y)
                  ...
                  any x {
                    ...
                    => (exists_unique y, forall a, a ∈ y <-> a ⊆ x) by set_ext;
